...
# Load bureau dataset
print(f'\n\nLoad bureau dataset:')
bureau = load_dataset(file_path=INPUT_CSV_1, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=bureau, max_rows=15)
...
print(f'\n\nLoad bureau balance dataset:')
bureau_balance = load_dataset(file_path=INPUT_CSV_2, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=bureau_balance, max_rows=15)
...
print(f'\n\nLoad credit card balance dataset:')
credit_card_balance = load_dataset(file_path=INPUT_CSV_3, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=credit_card_balance, max_rows=15)
...
print(f'\n\nLoad homecredit columns description dataset:')
homecredit_columns_description = load_dataset(
    file_path=INPUT_CSV_4, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=homecredit_columns_description, max_rows=15)
...
print(f'\n\nLoad installments payments dataset:')
installments_payments = load_dataset(file_path=INPUT_CSV_5, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=installments_payments, max_rows=15)
...
print(f'\n\nLoad pos cash balance dataset:')
pos_cash_balance = load_dataset(file_path=INPUT_CSV_6, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=pos_cash_balance, max_rows=15)
...
print(f'\n\nLoad previous application dataset:')
previous_application = load_dataset(file_path=INPUT_CSV_7, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=previous_application, max_rows=15)
...
print(f'\n\nLoad sample submission dataset:')
sample_submission = load_dataset(file_path=INPUT_CSV_8, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=sample_submission, max_rows=15)
...
print(f'\n\nLoad application train dataset:')
application_train = load_dataset(file_path=INPUT_CSV_9, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=application_train, max_rows=15)
...
print(f'\n\nLoad application test dataset:')
application_test = load_dataset(file_path=INPUT_CSV_10, encoding='utf-8')

# Display dataset information and description
dataset_info_description(dataset=application_test, max_rows=15)
...
dataset_info_description(dataset=customers_dataset, max_rows=15)
...
dataset_info_description(dataset=dashboard_dataset, max_rows=15)
